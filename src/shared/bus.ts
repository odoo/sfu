...
interface PendingRequest {
    resolve: (value: JSONSerializable) => void;
...
export class Bus {
    ...
    public onMessage?: (message: JSONSerializable) => void;
    /** Request handler for incoming requests */
    public onRequest?: (request: JSONSerializable) => Promise<JSONSerializable | void>;
     ...
     */
    request(message: JSONSerializable, options: RequestOptions = {}): Promise<JSONSerializable> {
    ...
    send(message: JSONSerializable, options: SendOptions = {}): void {
        const { batch } = options;
