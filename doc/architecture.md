...
flowchart TB
 subgraph s1["SFU"]
        ...
        Recorder["Recorder"]
        Media["Scheduler Service<br>(scheduling/monitoring)"]
        Session["Session"]
...
The Resources service manages the pool of worker processes and system resources.

-  Manages the pool of Mediasoup workers and balances their load.
